...
import { Button, Field, Input, Badge, Card, CardHeader, CardContent } from '../components/ui';
      ...
      <div className="relative w-full max-w-md">
        ...
        <Card className="bg-white rounded-3xl border border-line shadow-soft overflow-hidden">
          <CardHeader className="p-6 pb-4">
            ...
            <h1 className="font-display text-2xl font-bold text-ink">{isKhmer ? 'ចូលប្រើគណនី' : 'Sign in to your account'}</h1>
            <p className="text-sm text-ink-soft mt-1">{isKhmer ? 'ត្រលប់មកកាន់សំបុត្រ និងកម្មវិធីដែលអ្នកទិញ' : 'Welcome back to your tickets & events'}</p>
          </CardHeader>
