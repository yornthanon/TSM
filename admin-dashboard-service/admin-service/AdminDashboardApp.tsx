...
export const AdminDashboardApp: React.FC = () => {
  ...
  return (
    <div className="admin-shell min-h-screen bg-slate-50 text-slate-800">
      ...
      <aside className={`fixed inset-y-0 left-0 z-40 w-64 bg-slate-950 text-white border-r border-slate-800 transition-transform lg:translate-x-0 ${mobileOpen ? 'translate-x-0' : '-translate-x-full'}`}>
