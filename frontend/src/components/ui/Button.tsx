...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, disabled, children, ...props }, ref) => {
    ...
    const variants = {
      ...
      secondary: 'bg-dark-100 text-dark-900 hover:bg-dark-200 focus:ring-dark-400 dark:bg-dark-700 dark:text-dark-50 dark:hover:bg-dark-600',
      ...
      ghost: 'text-dark-600 hover:bg-dark-100 focus:ring-dark-400 dark:text-dark-400 dark:hover:bg-dark-800',
